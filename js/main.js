/*-----------------------------------------------------------------------------------
    ...
    ! function(t) {
      ...
      t("#preloader").fadeOut("normall", function() {
          ...
          e <= 50 ? (t("header").removeClass("scrollHeader").addClass("fixedHeader"), a.attr("src", "img/home/logo-g/foot-logo.png")) : (t("header").removeClass("fixedHeader").addClass("scrollHeader"), a.attr("src", "img/home/logo-g/foot-logo.png")), o.attr("src", "img/home/logo-g/foot-logo.png")
      }), n.on("scroll", function() {
